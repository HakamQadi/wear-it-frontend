...
import { ArrowRight, Camera, Move, ShoppingBag, Sparkles } from 'lucide-react';
...
export default function Home() {
  ...
  return <><Header/><main className="pageShell">
    <section className="hero"><div className="heroCopy"><span className="eyebrow">A smarter fitting room</span><h1>{content.heroTitle}</h1><p>{content.heroSubtitle}</p><div className="heroButtons"><Link href="/shop" className="button">{content.heroCta}<ArrowRight size={18}/></Link><Link href="#how-it-works" className="button secondary"><Sparkles size={17}/>How it works</Link></div></div><div className="heroVisual" aria-label="Wear It fashion illustration"><div className="heroModel"/><div className="heroCard"><span><Camera size={18}/></span><div><strong>Virtual try-on</strong><br/><small>Private, browser-based preview</small></div></div></div></section>
    ...
    <section className="featureBand" id="how-it-works"><div className="container"><span className="eyebrow" style={{color:'#b9cbbf'}}>Virtual fitting room</span><h2 style={{maxWidth:620,marginTop:10}}>A clearer idea of the look in three steps.</h2><div className="steps"><div className="stepCard"><div className="stepIcon"><ShoppingBag/></div><span className="stepNo">Step 01</span><h3>Choose a piece</h3><p>Shop products that include a try-on layer prepared by the store team.</p></div><div className="stepCard"><div className="stepIcon"><Camera/></div><span className="stepNo">Step 02</span><h3>Add your photo</h3><p>Upload a front-facing photo. It stays in your browser and is not sent to our server.</p></div><div className="stepCard"><div className="stepIcon"><Move/></div><span className="stepNo">Step 03</span><h3>Fine-tune the fit</h3><p>Move and scale the garment preview, then continue directly to the product and cart.</p></div></div></div></section>
  </main><Footer/></>;
}
